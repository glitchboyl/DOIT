...
final Future<void> Function() connectDB = () async => {
      _db = openDatabase(
        ...
        onCreate: (db, version) async {
          await db.execute(
            'CREATE TABLE to_do_list(id INTEGER PRIMARY KEY, title TEXT NOT NULL, remarks TEXT, type INTEGER NOT NULL, level INTEGER NOT NULL, startTime INTEGER NOT NULL, endTime INTEGER NOT NULL, repeatType INTEGER NOT NULL, completeTime INTEGER)',
          );
          await db.execute(
